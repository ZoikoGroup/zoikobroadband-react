...
export default function DigitalInclusionSec2() {
  return (
    <>
      ...
      <section className="w-full bg-[#fffff3] dark:bg-gray-900 flex flex-col lg:flex-row items-start lg:items-center justify-center gap-8 px-5 sm:px-10 md:px-16 lg:px-32 py-14">
        
        {/* LEFT */}
        <div className="w-full lg:w-[40%] flex flex-col">
          
          {/* Row 1 */}
          <h2 className="text-black dark:text-white font-bold text-2xl sm:text-3xl leading-tight mb-6">
          ...
          {[
            ...
            <div key={i} className="flex flex-row items-center gap-3 mb-5">
              ...
              <h3 className="text-[#494949] dark:text-gray-300 font-medium text-base sm:text-base md:text-xl">
                {item.label}
              </h3>
            </div>
          ))}
