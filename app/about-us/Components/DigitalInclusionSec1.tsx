...
export default function DigitalInclusionSec1() {
  return (
    ...
    {/* Digital Inclusion & Sustainability section1 */}
          <section className="w-full bg-[#f6c140] dark:bg-gray-950 flex flex-col lg:flex-row items-start lg:items-center justify-center gap-10  px-5 sm:px-10 md:px-16 lg:px-32 py-14 ">
            {/* LEFT IMAGE */}
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center">
              {/* Row 1 */}
              <h2 className="text-black dark:text-white  font-bold sm:text-2xl md:text-3xl lg:text-4xl leading-tight max-w-xl">
                Digital Inclusion & Sustainability
              </h2>
    
              {/* Row 2 */}
              <p className="text-black dark:text-white  text-base sm:text-lg md:text-xl leading-relaxed mt-6 max-w-xl">
