    ...
    <>
      ...
      <section className="w-full bg-white dark:bg-gray-900 py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-[#494949] dark:text-gray-300 text-base md:text-lg mt-4 mb-5 max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-items-center">
            {[
              ...
              <div key={logo.alt} className="w-full max-w-xs">
                <div className="bg-white dark:bg-gray-800 rounded-xl w-full h-20 sm:h-24 flex items-center justify-center p-3">
      ...
      <section className="bg-[#756DE7] dark:bg-[#5a52c9] w-full flex flex-col items-center justify-center py-4 sm:py-10 px-0">
