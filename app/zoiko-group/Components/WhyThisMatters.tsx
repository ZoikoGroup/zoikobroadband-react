        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="bg-[#f8f9fa] dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 px-6 py-10 flex flex-col items-center justify-between gap-3 hover:shadow-2xl transition-shadow duration-300"
              >
                <Image
                  src={item.src}
                  alt={item.label}
                ...
                <h3 className="text-center text-lg lg:text-2xl font-bold text-[#10446C] dark:text-white mb-4">
                  {item.label}
                </h3>

                <p className="text-center text-base lg:text-lg font-normal text-[#555555] dark:text-gray-300 leading-8">
                  {item.description}
                </p>
