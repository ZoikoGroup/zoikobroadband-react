    ...
    <>
      <section className="w-full bg-[#f8f9fa] py-16 px-4 sm:px-6 lg:px-8 lg:py-18 dark:bg-gray-950  dark:text-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          {/* Description */}
          <p className="mt-6 text-base md:text-lg lg:text-xl  dark:bg-gray-950  dark:text-white text-[#555555] leading-relaxed md:leading-9 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 dark:bg-gray-950  dark:text-white">
            {OurBrands.map((item, i) => (
              ...
              >
                ...
                {/* Title */}
                <h3 className="text-xl md:text-2xl font-semibold dark:text-[#63a7db] text-[#0f3d5e]">
                  {item.name}
                </h3>

                {/* Subtitle */}
                <p className="text-sm md:text-base dark:text-[#63a7db] text-gray-500">
                  {item.title}
                </p>
              </div>
            ))}
