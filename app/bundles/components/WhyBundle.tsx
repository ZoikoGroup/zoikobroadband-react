      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h2
            ...
            className="text-[#10446C] text-2xl md:text-3xl font-semibold mb-6"
          >
            Why Bundle with Zoiko
            <span className="block w-16 h-0.75 bg-amber-400 mx-auto mt-2"></span>
          </h2>
            ...
            {features.map((item) => (
              <li key={item.label}>
                <div className="flex flex-col items-center text-center px-4 transition-transform duration-300 hover:-translate-y-1">
                  ...
                  <h3 className="text-[#10446C] text-lg md:text-xl font-semibold mt-6">
                    {item.label}
                  </h3>

                  <p className="text-gray-600 text-sm md:text-base leading-relaxed mt-3 max-w-xs">
                    {item.description}
                  </p>
                </div>
              </li>
