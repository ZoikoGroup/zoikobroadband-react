...
dark:text-[#63a7db] text-[#10446C]">
          ...
          <div className="lg:col-span-3 space-y-12">
            {/* Section 1 */}
            <div id="section-1">
              <h2 className="text-2xl font-semibold text-[#10446C] dark:bg-gray-950  
dark:text-[#63a7db]">
                1. Agreement Overview
              </h2>
              <p className="mt-4 text-base md:text-lg dark:bg-gray-950  dark:text-white text-gray-700 leading-relaxed">
...
dark:text-[#63a7db] ">
              ...
              <p className="mt-4 text-base md:text-lg text-gray-700  dark:text-white leading-relaxed">
...
dark:text-[#63a7db] text-[#10446C]">
            ...
            {/* Section 7 */}
            <div id="section-7">
              <h2 className="text-2xl font-semibold dark:text-[#63a7db] text-[#10446C] dark:bg-gray-950">
...
dark:text-[#63a7db] text-[#10446C]">
              ...
              <p className=" dark:bg-gray-950  dark:text-white mt-4 text-base md:text-lg text-gray-700 leading-relaxed">
...
dark:text-[#63a7db]">
            ...
            {/* Section 13 */}
            <div id="section-13">
              <h2 className="text-2xl font-semibold dark:bg-gray-950  
dark:text-[#63a7db] text-[#10446C]">
      ...
      {/* key highlights... */}
      <section className="w-full  dark:bg-gray-950  dark:text-white bg-[#f9f9f9] py-16 px-4 sm:px-6 lg:px-18">
        <div className="max-w-7xl mx-auto">
          {/* Section Heading */}
          <h2 className="text-xl sm:text-2xl font-semibold 
dark:text-[#63a7db] text-[#10446C] mb-8">
            Key Highlights
          </h2>
