    ...
    <>
      ...
      >
        <div className="max-w-5xl mx-auto text-white text-center">
          ...
          <p className="mt-2 text-base md:text-xl  text-white/90 max-w-3xl mx-auto">
      ...
      <section
        ...
        className=" bg-[#f8fafc] flex flex-col items-center py-16 px-4 sm:px-6 lg:px-8 lg:py-20"
      >
        <h2
        ...
        <p className=" mb-4 text-center text-sm md:text-base text-[#555555] leading-relaxed max-w-2xl mx-auto">
          Select the option that best describes your situation
        </p>

        <div className="bg-white border border-gray-300 rounded-xl p-1 md:p-2 flex flex-col md:flex-row gap-2 md:gap-3">
          {tabs.map((tab) => (
            <button
              key={tab.id}
        ...
        rounded-xl font-semibold md:font-bold border border-gray-300 transition whitespace-nowrap
              ${
                activeTab === tab.id
            ...
            >
              {tab.label}
              <p className="text-xs sm:text-sm font-normal md:font-medium mt-1 text-gray-600">
                {tab.description}
              </p>
            </button>
          ))}
