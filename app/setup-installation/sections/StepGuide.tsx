...
const stepData = {
  new: [
    ...
    },
    {
      ...
      description:
        "Instructions for connecting your cables, power, and any other required hardware.",
    },
    {
      id: 3,
      title: "Power On & Wait",
    ...
    },
    {
      ...
      description:
        "If something isn't working, follow the troubleshooting steps or contact support.",
    },
  ],
  ...
  replacement: [
    {
      ...
      description:
        "If your router develops a fault or is no longer supported, you can request a replacement through My Account or by contacting Zoiko Support. Where the fault occurs during your contract, replacements are provided free of charge under Ofcom consumer protection rules.",
    },
    {
      id: 2,
      title: "Will I be charged for a replacement router?",
      description:
        "Routers under warranty or covered by your service agreement are replaced free of charge. Out-of-warranty replacements may carry a fee, which will always be confirmed before dispatch.",
    },
    {
      id: 3,
      title: "How do I return my old router?",
      description:
        "We include a pre-paid returns bag with your new router. Please return the old equipment within 14 days. Returned units are either refurbished for reuse or recycled responsibly in line with our sustainability commitments.",
    },
    {
      id: 4,
      title: "How do I set up my new router?",
      description:
        "Disconnect your old router and connect the new one using the supplied cables. Step-by-step instructions and a video guide are available online. Our support team can walk you through setup or, if needed, arrange an engineer visit.",
    },
    {
      id: 5,
      title: "Will my Wi-Fi name and password change?",
      description:
        "Each router has a default Wi-Fi name and password printed on the back. To keep your existing network details, use the Zoiko app to transfer settings securely from your old router.",
    },
    {
      id: 6,
      title: "What if the replacement router doesn’t work?",
      description:
        "Contact Zoiko Support immediately. We can run remote diagnostics, dispatch a new unit if required, or book an engineer visit at no cost if the fault is service-related. Throughout the process, we’ll keep you connected wherever possible.",
    },
  ],
