...
export default function OurMeasurable() {
  return (
    <>
      ...
      <section className="w-full py-10 px-5 sm:px-10 dark:bg-gray-950">

        <div className="max-w-7xl mx-auto text-center">

          <h2 className="text-2xl sm:text-4xl font-bold text-[#10446C] dark:text-white">
            Our M
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            ...
            {[
              ...
              <div
                key={i}
                className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 px-6 py-12 flex flex-col items-center justify-between gap-3 hover:shadow-2xl transition-shadow duration-300"
              >
                ...
                <h3 className="text-center text-lg lg:text-2xl font-bold text-[#10446C] dark:text-white">
                  {item.label}
                </h3>
                ...
                <p className="text-center text-sm lg:text-base font-normal text-[#10446C] dark:text-gray-300">
                  {item.description}
                </p>

                <div className="w-[90%] h-1 border-2 border-gray-300 dark:border-gray-600"></div>

                <p className="text-center text-sm lg:text-base font-bold text-[#10446C] dark:text-white">
