    ...
    <>
      ...
      <section className="flex justify-center py-16 px-4 dark:bg-gray-950">
        ...
        <div className="max-w-xl w-full">
          ...
          {/* Card */}
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-lg px-6 sm:px-10 py-8 flex flex-col items-center dark:border dark:border-gray-700">
            ...
            <div className="text-[#10446C] dark:text-white sm:text-left w-full max-w-lg">
              ...
              <p className="text-sm sm:text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">
              ...
              {/* Button */}
              <button className="bg-[#10446C] dark:bg-gray-800 w-full text-white px-6 py-3 rounded-xl hover:bg-[#0c3654] transition duration-300">
                Contact Us
              </button>
