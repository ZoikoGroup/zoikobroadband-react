      ...
      <section className="flex justify-center py-16 px-4">
        <div className="max-w-xl w-full">
          ...
          <div className="bg-white rounded-3xl shadow-lg px-6 sm:px-10 py-8 flex flex-col items-center ">
            ...
            {/* Content */}
            <div className="text-[#10446C] sm:text-left w-full">
              ...
              <Link href={"/contact-us"}>
                <div className="bg-[#10446C] w-full text-center  text-white px-6 py-3 rounded-xl hover:bg-[#0c3654] transition duration-300">
                  Contact Us
                </div>
              </Link>
              {/* Progress text */}
