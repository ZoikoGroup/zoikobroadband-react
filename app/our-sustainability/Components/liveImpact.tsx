        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            {[
              ...
              <div
                key={i}
                className="relative bg-white dark:bg-gray-900 rounded-3xl shadow-[0_10px_25px_rgba(0,0,0,0.08)] dark:border dark:border-gray-700 px-10 py-12 pt-10 flex flex-col items-center text-center transition-all duration-300 hover:shadow-xl"
              >
                ...
                {/* Title */}
                <h3 className="text-xl lg:text-2xl font-bold text-[#10446C] dark:text-white mb-2">
                  {item.label}
                </h3>
                ...
                {/* Units */}
                <p className="text-sm lg:text-base text-gray-500 dark:text-gray-300 mb-4">
                  {item.units}
                </p>

                {/* Description */}
                <p className="text-sm lg:text-base text-gray-500 dark:text-gray-300 mb-3">
                  {item.description}
                </p>
