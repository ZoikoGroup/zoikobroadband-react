    ...
    <>
      <section className="flex justify-center px-4 py-12 sm:py-14  dark:bg-gray-950 dark:text-white">
        <div
          ...
          {/* LEFT CONTENT */}
          <div className="text-white lg:w-2/3 text-center lg:text-left dark:bg-gray-950 dark:text-white">
            <h2 className="text-2xl sm:text-3xl lg:text-3xl font-bold mb-4">
              Ready to Build the Future?
            </h2>

            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-xl mx-auto lg:mx-0 dark:bg-gray-950 dark:text-white">
