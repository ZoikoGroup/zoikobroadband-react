  ...
  return (
    <>
      <section
        ...
        className="w-full bg-[#fffcf4] py-16 dark:bg-gray-900 dark:text-white  "
      >
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16  dark:text-white">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2
                id="benefits-heading"
                className="text-black font-bold text-3xl md:text-4xl mb-2 dark:bg-gray-900 dark:text-white"
              >
                Benefits of Zoiko Broadband
              </h2>

              <p className="text-gray-600 text-base md:text-lg mb-8  dark:text-white">
              ...
              <ul className="space-y-5">
                {benefits.map((item) => (
                  <li key={item.label}>
                    <article className="dark:bg-gray-900  dark:text-white bg-white border border-gray-200 p-5 rounded-2xl flex items-center gap-4 shadow-sm hover:shadow-md transition">
                      <Image
                        src={item.src}
                        alt=""
                        aria-hidden="true"
                      ...
                      <div>
                        <h3 className="  dark:text-white text-black font-semibold text-lg md:text-xl">
                          {item.label}
                        </h3>
                        <p className="  dark:text-white text-gray-600 text-sm md:text-base mt-1">
                          {item.title}
                        </p>
                      </div>
                    </article>
