  ...
  return (
    <>
      <section
        ...
        className="bg-[#dfe8ee] w-full py-16 dark:bg-gray-950 dark:text-white"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            ...
            <div>
              <h2
                ...
                className="text-black text-2xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6 dark:bg-gray-950 dark:text-white"
              >
                See If Zoiko Fibre Is Ready at Your Address
              </h2>

              <p className="text-gray-700 text-base md:text-lg leading-relaxed max-w-xl dark:bg-gray-950 dark:text-white">
